...
import './CinemaOctober.css'

import React, { Component } from 'react'

export default class CinemaOctober extends Component {
    state = {
        activeNum: [],
        totalPrice: 0
    }
                ...
                <div className="seat-place">
                    ...
                    <div className="seat-place__place">
                        <div className="place-row">
                            ...
                            <div className="place"><span className={this.state.activeNum.includes('14.1') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="14.1" data-price="6.50">14</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('15.1') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="15.1" data-price="6.50">15</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('16.1') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="16.1" data-price="6.50">16</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('17.1') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="17.1" data-price="6.50">17</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('18.1') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="18.1" data-price="6.50">18</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('19.1') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="19.1" data-price="6.50">19</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('20.1') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="20.1" data-price="6.50">20</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('21.1') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="21.1" data-price="6.50">21</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('22.1') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="22.1" data-price="6.50">22</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('23.1') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="23.1" data-price="6.50">23</span></div>
                        </div>
                        ...
                        <div className="place-row">
                            ...
                            <div className="place"><span className={this.state.activeNum.includes('17.2') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="17.2" data-price="6.50">17</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('18.2') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="18.2" data-price="6.50">18</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('19.2') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="19.2" data-price="6.50">19</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('20.2') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="20.2" data-price="6.50">20</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('21.2') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="21.2" data-price="6.50">21</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('22.2') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="22.2" data-price="6.50">22</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('23.2') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="23.2" data-price="6.50">23</span></div>
                        </div>
                        ...
                        <div className="place-row">
                            ...
                            <div className="place"><span className={this.state.activeNum.includes('17.3') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="17.3" data-price="6.50">17</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('18.3') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="18.3" data-price="6.50">18</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('19.3') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="19.3" data-price="6.50">19</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('20.3') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="20.3" data-price="6.50">20</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('21.3') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="21.3" data-price="6.50">21</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('22.3') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="22.3" data-price="6.50">22</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('23.3') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="23.3" data-price="6.50">23</span></div>
                        </div>
                        ...
                        <div className="place-row">
                            ...
                            <div className="place"><span className={this.state.activeNum.includes('17.4') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="17.4" data-price="6.50">17</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('18.4') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="18.4" data-price="6.50">18</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('19.4') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="19.4" data-price="6.50">19</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('20.4') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="20.4" data-price="6.50">20</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('21.4') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="21.4" data-price="6.50">21</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('22.4') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="22.4" data-price="6.50">22</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('23.4') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="23.4" data-price="6.50">23</span></div>
                        </div>
                        ...
                        <div className="place-row">
                            ...
                            <div className="place"><span className={this.state.activeNum.includes('16.5') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="16.5" data-price="6.50">16</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('17.5') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="17.5" data-price="6.50">17</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('18.5') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="18.5" data-price="6.50">18</span></div>
                        </div>
                        ...
                        <div className="place-row">
                            ...
                            <div className="place"><span className={this.state.activeNum.includes('16.6') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="16.6" data-price="6.50">16</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('17.6') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="17.6" data-price="6.50">17</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('18.6') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="18.6" data-price="6.50">18</span></div>
                        </div>
                        ...
                        <div className="place-row">
                            ...
                            <div className="place"><span className={this.state.activeNum.includes('16.7') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="16.7" data-price="6.50">16</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('17.7') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="17.7" data-price="6.50">17</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('18.7') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="18.7" data-price="6.50">18</span></div>
                        </div>
                        ...
                        <div className="place-row">
                            <div className="place"><span className={this.state.activeNum.includes('1.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="1.9" data-price="6.50">1</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('2.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="2.9" data-price="6.50">2</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('3.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="3.9" data-price="6.50">3</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('4.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="4.9" data-price="6.50">4</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('5.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="5.9" data-price="6.50">5</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('6.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="6.9" data-price="6.50">6</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('7.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="7.9" data-price="6.50">7</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('8.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="8.9" data-price="6.50">8</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('9.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="9.9" data-price="6.50">9</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('10.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="10.9" data-price="6.50">10</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('11.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="11.9" data-price="6.50">11</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('12.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="12.9" data-price="6.50">12</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('13.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="13.9" data-price="6.50">13</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('14.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="14.9" data-price="6.50">14</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('15.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="15.9" data-price="6.50">15</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('16.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="16.9" data-price="6.50">16</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('17.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="17.9" data-price="6.50">17</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('18.9') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="18.9" data-price="6.50">18</span></div>
                        </div>

                        <div className="place-row">
                            <div className="place"><span className={this.state.activeNum.includes('1.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="1.10" data-price="6.50">1</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('2.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="2.10" data-price="6.50">2</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('3.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="3.10" data-price="6.50">3</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('4.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="4.10" data-price="6.50">4</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('5.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="5.10" data-price="6.50">5</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('6.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="6.10" data-price="6.50">6</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('7.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="7.10" data-price="6.50">7</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('8.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="8.10" data-price="6.50">8</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('9.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="9.10" data-price="6.50">9</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('10.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="10.10" data-price="6.50">10</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('11.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="11.10" data-price="6.50">11</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('12.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="12.10" data-price="6.50">12</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('13.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="13.10" data-price="6.50">13</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('14.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="14.10" data-price="6.50">14</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('15.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="15.10" data-price="6.50">15</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('16.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="16.10" data-price="6.50">16</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('17.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="17.10" data-price="6.50">17</span></div>
                            <div className="place"><span className={this.state.activeNum.includes('18.10') ? "span activeE" : "span"} onClick={this.ClickHandler} data-place="18.10" data-price="6.50">18</span></div>
                        </div>
                    </div>
