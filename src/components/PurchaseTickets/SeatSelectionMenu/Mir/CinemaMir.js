...
import './CinemaMir.css';


export default class CinemaMir extends Component {
    state = {
        activeNum: [],
        totalPrice: 0
    }
...
//                     <div className="seat-place__place">
//                         <div className="place-row">
//                             <div className="place"><span className="span">1</span></div>
//                             <div className="place"><span className="span">2</span></div>
//                             <div className="place"><span className="span">3</span></div>
//                             <div className="place"><span className="span">4</span></div>
//                             <div className="place"><span className="span">5</span></div>
//                             <div className="place"><span className="span">6</span></div>
//                             <div className="place"><span className="span">7</span></div>
//                             <div className="place"><span className="span">8</span></div>
//                             <div className="place"><span className="span">9</span></div>
//                             <div className="place"><span className="span">10</span></div>
//                             <div className="place"><span className="span">11</span></div>
//                             <div className="place"><span className="span">12</span></div>
//                             <div className="place"><span className="span">13</span></div>
//                             <div className="place"><span className="span">14</span></div>
//                             <div className="place"><span className="span">15</span></div>
//                             <div className="place"><span className="span">16</span></div>
//                         </div>
...
//                             <div className="place"><span className="span">15</span></div>
//                             <div className="place"><span className="span">16</span></div>
//                             <div className="place"><span className="span">17</span></div>
//                             <div className="place"><span className="span">18</span></div>
//                         </div>
